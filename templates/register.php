<?php
    $emailIncorrectMessage = $data['emailIncorrectMessage'] ?? '';
        ...
        <main class="content__main">
          ...
          <form class="form" action="/pages/register.php" method="post">
            <div class="form__row">
              ...
              <p class="form__message"><?= $emailIncorrectMessage; ?></p>
            </div>
            ...
            <div class="form__row">
              ...
              <input class="form__input" type="text" name="name" id="name" value="<?= $userName; ?>" placeholder="Введите имя">
            </div>
